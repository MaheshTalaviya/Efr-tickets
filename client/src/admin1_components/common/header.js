    ...
    return(
        <div  className="nax-bar-main ">
            ...
            <button className="welcome-btn link-btn">{`Welcome ${authUser.email}`}</button>
                ...
                <ul>
                    {/* <li>
                    <NavLink to={`/admin1/uploadCsv`}>Upload CSV</NavLink>
                    </li>
                    <li>
                    <NavLink to={`/admin1/instagramList`}>Instagram List</NavLink>
                    </li>*/}
                    <li> 
                    <NavLink to={`/admin1/urgentEFRTicket`}>Urgent ({urgentTotal})</NavLink>
                    </li>
                    <li>
                    <NavLink to={`/admin1/elevatedEFRTicket`}>Elevated ({elevatedTotal})</NavLink>
                    </li>
                    <li>
                    <NavLink to={`/admin1/normalEFRTicket`}>Normal ({normalTotal})</NavLink>
                    </li>
                    <li>
                    <NavLink to={`/admin1/skipForeverEFRTicket`}>Skip forever ({skipForeverTotal})</NavLink>
                    </li>
                    <li>
