...
const ElevatedEFRTicket = () => {
    ...
    const fetchData = () =>{
        ...
        try {
            ...
            axios.get(SERVER_URL + `/api/efrticket/getEFRTicketByPriorityLevel/ELEVATED/ADMIN1/${user._id}`).then((res)=>{
...
export default ElevatedEFRTicket;