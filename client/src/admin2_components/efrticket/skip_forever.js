...
//SkipForeverEFRTicket
const ADMIN2SkipForeverEFRTicket = () => {
    ...
    const fetchData = () =>{
        try {
            ...
            axios.get(SERVER_URL + "/api/efrticket/getSkipForeverEFRTicket/ADMIN2").then((res)=>{
...
export default ADMIN2SkipForeverEFRTicket;