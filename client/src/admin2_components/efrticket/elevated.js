...
const ADMIN2ElevatedEFRTicket = () => {
    ...
    const fetchData = () =>{
        try {
            ...
            axios.get(SERVER_URL + "/api/efrticket/getEFRTicketByPriorityLevel/ELEVATED/ADMIN2").then((res)=>{
...
export default ADMIN2ElevatedEFRTicket;