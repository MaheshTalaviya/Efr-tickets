    ...
    return(
        <div  className="nax-bar-main ">
            ...
            <button className="welcome-btn link-btn">{`Welcome ${authUser.email}`}</button>
                ...
                <ul>
                    <li>
                    <NavLink to={`/admin2/urgentEFRTicket`}>Urgent ({urgentTotal})</NavLink>
                    </li>
                    <li>
                    <NavLink to={`/admin2/elevatedEFRTicket`}>Elevated ({elevatedTotal})</NavLink>
                    </li>
                    <li>
                    <NavLink to={`/admin2/normalEFRTicket`}>Normal ({normalTotal})</NavLink>
                    </li>
                    <li>
                    <NavLink to={`/admin2/skipForeverEFRTicket`}>Skip forever ({skipForeverTotal})</NavLink>
                    </li>
                    <li>
                    <NavLink to={`/admin2/assignAgents`}>Assign Agents</NavLink>
                    </li>
                                        <li>
                    <NavLink to={`/admin2/ecpNotes`}>ECP Notes</NavLink>
                    </li>
                    <li>
